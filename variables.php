<?php
/**
 * The question_formulas_variables class is used to parse and evaluate variables.
 *
...
class question_formulas_variables {
    ...
    function unit_test() {
        $numcase = 0;
        $numcorrect = 0;
        echo '~~~ Start the unit test for the question_formulas_variable ~~~<br><br>';
        try {
...
//require_once("../../../config.php");    $v = new question_formulas_variables();  $v->unit_test();
