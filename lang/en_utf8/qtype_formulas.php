...
$string['helponquestionoptions'] = 'all question options';
$string['helpdirection'] = 'For help on question options, click the help button on the left. For full documentation, click the help button at the top of this form.';
